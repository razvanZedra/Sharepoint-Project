...
var CollectionNumberField = (function (_super) {
    ...
    CollectionNumberField.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: PropertyFieldCollectionDataHost_module_scss_1.default.numberField + " " + (this.state.errorMessage ? PropertyFieldCollectionDataHost_module_scss_1.default.invalidField : "") },
            React.createElement("input", { type: "number", role: "spinbutton", placeholder: this.props.field.placeholder || this.props.field.title, "aria-valuemax": "99999", "aria-valuemin": "-999999", "aria-valuenow": this.props.item[this.props.field.id] || '', "aria-invalid": !!this.state.errorMessage, value: this.state.value || '', onChange: function (ev) { return _this.valueChange(_this.props.field, ev.target.value); } })));
    };
