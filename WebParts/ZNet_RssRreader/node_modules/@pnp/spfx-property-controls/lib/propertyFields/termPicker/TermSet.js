    ...
    function TermSet(props) {
        ...
        _this.termSetSelectionChange = function (ev, isChecked) {
            ...
            _this.props.changedCallback({
                Id: SPTermStorePickerService_1.default.cleanGuid(termset.Id),
                Name: termset.Name,
                PathOfTerm: "",
            ...
            if (this.state.loaded) {
                if (this.state.terms.length > 0) {
                    termElm = (React.createElement("div", { style: styleProps }, this.state.terms.map(function (term) {
                        ...
                        return React.createElement(Term_1.default, { key: term.Id, term: term, termset: _this.props.termset.Id, activeNodes: _this.props.activeNodes, changedCallback: _this.props.changedCallback, multiSelection: _this.props.multiSelection, disabled: disabled });
                    })));
                }
                else {
