...
var SecurityTrimmedControl = (function (_super) {
    ...
    SecurityTrimmedControl.prototype.checkRemoteListOrLibPermissions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, context, remoteSiteUrl, relativeLibOrListUrl, permissions, apiUrl, result, permission, hasPermissions;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, context = _a.context, remoteSiteUrl = _a.remoteSiteUrl, relativeLibOrListUrl = _a.relativeLibOrListUrl, permissions = _a.permissions;
    ...
    SecurityTrimmedControl.prototype.render = function () {
        return (this.state.allowRender ? (React.createElement("div", null, this.props.children)) : null);
    };
