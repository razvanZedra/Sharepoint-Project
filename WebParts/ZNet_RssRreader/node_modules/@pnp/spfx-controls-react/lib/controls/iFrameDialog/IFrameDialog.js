...
var IFrameDialog = (function (_super) {
    ...
    IFrameDialog.prototype.render = function () {
        return (React.createElement(Dialog_1.Dialog, __assign({ className: this.state.dialogId + " " + this.props.className }, omit(this.props, "className")),
            React.createElement(IFrameDialogContent_1.IFrameDialogContent, { url: this.props.url, iframeOnLoad: this.props.iframeOnLoad, close: this.props.onDismiss, width: this.props.width, height: this.props.height })));
    };
    /**
