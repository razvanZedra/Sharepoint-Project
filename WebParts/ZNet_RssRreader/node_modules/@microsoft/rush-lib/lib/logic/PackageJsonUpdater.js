...
class PackageJsonUpdater {
     ...
     */
    doRushAdd(options) {
        const { currentProject, packageName, initialVersion, devDependency, updateOtherPackages, skipUpdate, debugInstall, rangeStyle } = options;
        ...
        const purgeManager = new PurgeManager_1.PurgeManager(this._rushConfiguration);
        const installManager = new InstallManager_1.InstallManager(this._rushConfiguration, purgeManager);
