...
export declare class Executable {
     ...
     */
    private static _getEscapedForWindowsShell(text);
    /**
...
export declare class Terminal {
    ...
    private _writeSegmentsToProviders(segments, severity);
    private _serializeFormattableTextSegments(segments, withColor);
}
