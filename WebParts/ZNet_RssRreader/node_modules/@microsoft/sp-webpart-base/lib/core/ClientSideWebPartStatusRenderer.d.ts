...
export default class ClientSideWebPartStatusRenderer implements IClientSideWebPartStatusRenderer {
    ...
    private _createLoadingIndicator(domElement, loadingMessage, timeout?, performanceLogEventName?);
    private _renderSpinner(domElement, loadingMessage, showSpinner);
    private _getCacheEntry(domElement);
    private _createSpinnerElement(domElement, showSpinner, loadingMessage);
    private _clearChildren(element);
}
