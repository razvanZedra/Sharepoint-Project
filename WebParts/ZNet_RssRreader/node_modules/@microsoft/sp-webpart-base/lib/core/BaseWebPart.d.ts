...
import { IPropertyPaneConfiguration, IPropertyPaneData } from '../propertyPane/propertyPane/IPropertyPane';
...
export default abstract class BaseWebPart<TProperties> extends BaseComponent implements IPropertyPaneConsumer {
     ...
     *
     * @remarks
     * If the old value is of type DynamicProperty, but the new value is a static value (This could
     * happen when the same property is used as the targetProperty for both DynamicField and a TextField.)
     *  then update the dynamic property's static value with the new value and
     *    then update the properties bag with the updated old value.
     ...
     */
    private _initializeDynamicPropertiesIfRequired(deSerializedProperties);
    /**
