...
export default class ClientSideWebPartManager {
     ...
     */
    private _onWebPartRendered(context, renderEndTime);
    /**
     ...
     */
    private _executeForIdsOrAll(instanceIds, callback);
     ...
     */
    private _onAllWebpartsAdded(context, startTime?);
    /**
     * TODO: Retire along with isViewportLoadTimeoutKillSwitchActivated
     */
    private _onAllWebpartsAddedOld(context);
    ...
    */
     ...
     */
    private _ensureUrl(isolatedDomain, absoluteUrl);
}
