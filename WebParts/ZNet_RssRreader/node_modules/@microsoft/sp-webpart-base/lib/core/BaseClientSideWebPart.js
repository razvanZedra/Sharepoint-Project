...
var BaseClientSideWebPart = (function (_super) {
    ...
    BaseClientSideWebPart._isClearMinHeightKillSwitchActivated = function () {
        return _SPKillSwitch.isActivated(Guid.parse('87770e5b-c703-4715-b592-ed34b5f68e0f'), '10/03/2018', 'ClearMinHeightOnRenderPromise');
    };
        ...
        if (this.displayMode === DisplayMode.Edit) {
            ...
            if (accessibleContext) {
                ...
                if (isNewLabelElement) {
                    ...
                    if (!KillSwitches.isRemoveHiddenElementFocusA11yKillSwitchActivated()) {
