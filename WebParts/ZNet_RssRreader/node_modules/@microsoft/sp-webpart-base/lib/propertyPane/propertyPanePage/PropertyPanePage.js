...
var PropertyPanePage = (function (_super) {
    ...
    PropertyPanePage.prototype.render = function () {
        var _this = this;
        var index = 0;
        if (!KillSwitches.isPropertyPaneConditionalGroupKillSwitchActivated()) {
            ...
            var propertyGroups = this.props.propertyGroups.map(function (group) {
                group = group;
                return (React.createElement(PropertyPaneGroup, tslib_1.__assign({}, _this.props, { key: group.groupName || index++, pageNumber: _this.props.pageNumber, groupName: group.groupName, groupFields: group.groupFields, onChange: _this.props.onChange, properties: _this.props.properties, setEntryState: _this.props.setEntryState, isCollapsed: group.isCollapsed, displayGroupsAsAccordion: _this.props.displayGroupsAsAccordion, propertyPaneGroupStateChanged: _this.props.propertyPaneGroupStateChanged, propertyPanePagesStateMap: _this.props.propertyPanePagesStateMap, dynamicConfiguration: _this.props.dynamicConfiguration })));
            });
            return (React.createElement("div", { ref: function (c) { return _this._propertyPanePage = c; } },
                this.props.pageDescription
                    ? React.createElement("div", { className: propertyPanePageStyles.propertyPanePageDescription, id: 'propertyPaneDescriptionId' }, this.props.pageDescription)
