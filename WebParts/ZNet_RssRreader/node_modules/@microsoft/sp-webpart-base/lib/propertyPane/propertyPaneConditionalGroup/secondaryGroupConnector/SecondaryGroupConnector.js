...
import { autobind, BaseComponent, Callout, DefaultButton } from '@microsoft/office-ui-fabric-react-bundle';
        ...
        return (React.createElement("div", { className: styles.alternateFieldsConnector, role: 'button', onClick: this._handleConnectorClick },
            ...
            isCalloutVisible &&
                React.createElement("div", { className: styles.callout },
                    React.createElement(Callout, { role: 'alertdialog', isBeakVisible: false, setInitialFocus: true, directionalHint: 5 , onDismiss: this._handleCalloutDismiss, target: this._ellipsisELement },
