...
export default class DynamicDataWidgetEntry extends React.Component<IDynamicDataWidgetEntryProps, IDynamicDataWidgetEntryState> {
     ...
     */
    private _getDropdownForSubProperty(level, propertyPath, selectedKey?);
    /**
     ...
     */
    private _getDropdownOptions(propValue, propertyPath, recursiveCall, selectedKey?);
    /**
     ...
     * @param propertyPath - property path to the current level
     */
    private _getSubPropertyValueObject(propertyPath);
