...
export default class IframedWebPartController {
     ...
     *  @param webPartManagerContext - web part manager context.
     */
    private _generateIframeSrcUrl(domainUrl, pageContext, webPartManagerContext);
    /**
     ...
     * @param instanceId
     */
    private _createPropertyPaneElement(instanceId);
    /**
     * Event listener that takes actions on behalf of iframed webparts.
     */
    private _iframeEventListener(event);
    /**
     ...
     *
     */
    private _updateWebPartDisplayMode(instanceId);
    /**
     ...
     */
    private _updateWebPartData(instanceId, webPartData, action);
