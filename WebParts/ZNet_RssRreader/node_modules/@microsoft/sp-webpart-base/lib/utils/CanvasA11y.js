...
export function getFirstFocusableChild(elem, ignoreTabIndex) {
    ...
    if (!_SPKillSwitch.isActivated(Guid.parse('f83774fb-881e-4579-ae70-1dfeae42e5b6'), '10/26/2017', 'Focus on selected child of radio input group if radio input group is the first focusable child')) {
