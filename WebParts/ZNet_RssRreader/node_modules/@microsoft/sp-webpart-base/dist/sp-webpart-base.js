define("974a7777-0990-4136-8fa6-95d80114c2e0_1.7.0", ["@microsoft/sp-core-library","@microsoft/decorators","@microsoft/sp-diagnostics","react","@microsoft/sp-lodash-subset","@microsoft/load-themed-styles","@ms/sp-telemetry","@microsoft/office-ui-fabric-react-bundle","@microsoft/sp-component-base","react-dom","resx-strings","@ms/sp-load-themed-styles","@microsoft/sp-loader","@microsoft/sp-http","@microsoft/sp-page-context"], function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_13__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// install a JSONP callback for chunk loading
/******/ 	var parentJsonpFunction = window["webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_1_7_0"];
/******/ 	window["webpackJsonp974a7777_0990_4136_8fa6_95d80114c2e0_1_7_0"] = function webpackJsonpCallback(chunkIds, moreModules, executeModules) {
...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + chunkId + "." + ({}[chunkId]||chunkId) + "_" + {"0":"aff779f90abb5c5e2e84","1":"36b25e8f697ced0ed4d8","2":"288d34530becbf7e4683"}[chunkId] + ".js";
...
var KillSwitches = (function () {
    ...
    KillSwitches.isPropertiesCloningUsingDeepCloneWithKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('54a56fa6-4d6a-4bb3-b121-f87560316b17'), '07/27/2018', 'Web part properties serialization using lodash.cloneDeepWith to support dynamic properties.');
    };
    KillSwitches.isPersistedPropertiesUsingDisableReactivePropertyChangesKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('f6f90a64-5a49-4e02-bff3-40347857bf3f'), '08/21/2018', 'Persisting Web part properties is decided based on the disableReactivePropertyChanges flag.');
    };
    KillSwitches.isViewportLoadTimeoutKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('aaef94e9-6c29-4c87-a7b5-109b29c8d924'), '08/24/2018', 'Timeout viewport loading.');
    };
    KillSwitches.isPropertyPaneFocusKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].tryParse('906d3d30-8e88-46e0-a7a6-f36f1a07112a'), '08/29/2018', 'Do not focus on the Property Pane during a refresh');
    };
    KillSwitches.isPropertyPaneConditionalGroupKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('bddfe0a2-fc49-48ce-92de-f982c446c90c'), '08/29/2018', 'Conditional groups on property pane');
    };
    KillSwitches.isHideGroupNameOptionKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('7a7388bb-5739-4618-ac6c-c2dfbf2351d2'), '09/26/2018', 'Support group name can be hidden');
    };
    KillSwitches.isCheckManifestRequestKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('e85b924a-3dd8-40cf-83bd-faf7a82133e6'), '9/27/2018', 'SOX_CheckManifestRequest');
    };
    KillSwitches.isRejectLoadWebPartPromiseProperlyKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('f81b6dc5-855e-48ff-a58b-89548e5a6dcd'), '10/05/2018', 'Reject loadWebPartPromise properly in some cases');
    };
    KillSwitches.isCheckingAllWebPartsRenderedKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('ec33991c-8cc5-412c-b96c-3a75cac81f89'), '10/08/2018', 'Checking whether all web parts are rendered');
    };
    KillSwitches.isRemoveHiddenElementFocusA11yKillSwitchActivated = function () {
        return __WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["_SPKillSwitch"].isActivated(__WEBPACK_IMPORTED_MODULE_0__microsoft_sp_core_library__["Guid"].parse('27429dc2-4ea8-48e4-9a66-8ef874b8ae0d'), '10/19/2018', 'Remove narrator focus from hidden element');
    };
    return KillSwitches;
}());
...
var BaseWebPart_BaseWebPart = (function (_super) {
    ...
    Object.defineProperty(BaseWebPart.prototype, "persistedProperties", {
        get: function () {
            if (!KillSwitches["a" /* default */].isPersistedPropertiesUsingDisableReactivePropertyChangesKillSwitchActivated()) {
    ...
    BaseWebPart.prototype._cloneProperties = function (propertiesToClone) {
        if (!KillSwitches["a" /* default */].isPropertiesCloningUsingDeepCloneWithKillSwitchActivated()) {
...
var styles = {
    errorBox: 'errorBox_50ec6a71',
    errorBoxText: 'errorBoxText_50ec6a71',
    detailsButton: 'detailsButton_50ec6a71',
    somethingWentWrongText: 'somethingWentWrongText_50ec6a71',
    siteAdminText: 'siteAdminText_50ec6a71',
    screenReaderOnly: 'screenReaderOnly_50ec6a71',
};
...
var BaseClientSideWebPart_BaseClientSideWebPart = (function (_super) {
    ...
    BaseClientSideWebPart._isClearMinHeightKillSwitchActivated = function () {
        return sp_core_library_["_SPKillSwitch"].isActivated(sp_core_library_["Guid"].parse('87770e5b-c703-4715-b592-ed34b5f68e0f'), '10/03/2018', 'ClearMinHeightOnRenderPromise');
    };
        ...
        if (this.displayMode === sp_core_library_["DisplayMode"].Edit) {
            ...
            if (accessibleContext) {
                ...
                if (isNewLabelElement) {
                    ...
                    if (!KillSwitches["a" /* default */].isRemoveHiddenElementFocusA11yKillSwitchActivated()) {
            ...
            if (BaseClientSideWebPart._isClearMinHeightKillSwitchActivated()) {
...
var Placeholder_scss = __webpack_require__(24);
...
var spinner_module_scss_styles = {
    spinnerContainer: 'spinnerContainer_6416dc2d',
    spinner: 'spinner_6416dc2d',
    spinnerRing: 'spinnerRing_6416dc2d',
    spinnerSlice: 'spinnerSlice_6416dc2d',
    spin: 'spin_6416dc2d',
    spinnerLoadingMessage: 'spinnerLoadingMessage_6416dc2d',
    spinnerAccessibilityMessage: 'spinnerAccessibilityMessage_6416dc2d',
};
...
var ClientSideWebPartStatusRenderer_ClientSideWebPartStatusRenderer = (function () {
    ...
    ClientSideWebPartStatusRenderer.prototype.clearLoadingIndicator = function (domElement) {
        ...
        if (this._activeIndicatorCache.has(domElement)) {
            ...
            if (cacheEntry.placeholder) {
                if (cacheEntry.placeholder instanceof placeHolder_PlaceholderSpinner) {
    ...
    ClientSideWebPartStatusRenderer.prototype._createSpinnerElement = function (domElement, showSpinner, loadingMessage) {
        if (!sp_core_library_["_SPKillSwitch"].isActivated(sp_core_library_["Guid"].parse('522343b3-9f76-4860-962a-b159b1d1c5c2'), '8/28/2018', 'FallbackToUsingReactSpinner')) {
            ...
            return external__react_dom_["render"](el, domElement);
        }
    };
...
var PropertyPaneController_module_scss_styles = {
    showPane: 'showPane_415eb785',
    spPropertyPaneContainer: 'spPropertyPaneContainer_415eb785',
    shrinkContent: 'shrinkContent_415eb785',
};
...
var PropertyPaneController_PropertyPaneController = (function () {
    ...
    PropertyPaneController.prototype._loadPropertyPaneComponent = function (recreatePropertyPane) {
        var _this = this;
        __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 141))
...
function IframedWebPartControllerLoader() {
    return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 142)).then(function (iframedWebPartControllerModule) { return iframedWebPartControllerModule.default; });
}
...
var ClientSideWebPartManager_ClientSideWebPartManager = (function () {
    ...
    ClientSideWebPartManager.prototype.loadWebPart = function (context) {
        ...
        var loadWebPartPromise = new Promise(function (resolve, reject) {
            ...
            if (sp_core_library_["_SPFlight"].isEnabled(SPPPLAT_IFRAMED_WEBPART_CONTROLLER_FLIGHT_ID) &&
                ...
                return IframedWebPartControllerLoader().then(function (iframedWebPartControllerModule) {
                    ...
                    if (!KillSwitches["a" /* default */].isRejectLoadWebPartPromiseProperlyKillSwitchActivated()) {
                        reject(error);
                    }
                    throw error;
                });
        ...
        if (!KillSwitches["a" /* default */].isCheckingAllWebPartsRenderedKillSwitchActivated()) {
        ...
        if (!this._toolboxManifestsPromise) {
            ...
            this._host.serviceScope.whenFinished(function () {
                ...
                _this._toolboxManifestsPromise = httpClient.get(requestUrl_1, sp_http_["SPHttpClient"].configurations.v1)
                    ...
                    if (KillSwitches["a" /* default */].isCheckManifestRequestKillSwitchActivated() || response.ok) {
    ...
    ClientSideWebPartManager.prototype._onAllWebpartsAdded = function (context, startTime) {
        var _this = this;
        if (KillSwitches["a" /* default */].isViewportLoadTimeoutKillSwitchActivated()) {
            return this._onAllWebpartsAddedOld(context);
        }
        var timeout = 2000;
    ...
    ClientSideWebPartManager.prototype._onAllWebpartsAddedOld = function (context) {
        var _this = this;
        var endTime = this._getViewportRenderedEndTime();
        if (endTime) {
            window.setTimeout(function () { _this._onViewportWebpartsLoaded(context, endTime); }, 0);
            ...
            window.setTimeout(function () { _this._onAllWebpartsAddedOld(context); }, 100);
        }
    };
...
var MinimalWebPartContainer_MinimalWebPartContainer = (function () {
    ...
    MinimalWebPartContainer.prototype.render = function (domElement) {
        ...
        this._renderWebPart(this._domElement).then(function () {
    ...
    MinimalWebPartContainer.prototype.setDisplayMode = function (displayMode) {
        this._webPartManager.setDisplayMode(displayMode, this._props.webPartInstanceId);
    };
    MinimalWebPartContainer.prototype.requestPropertyPaneAction = function (instanceId, propertyPaneAction) {
    ...
    MinimalWebPartContainer.prototype._getHeight = function () {
        ...
        return domElementChild.scrollHeight;
    };
    MinimalWebPartContainer.prototype._getWidth = function () {
        sp_core_library_["Validate"].isNotNullOrUndefined(this._domElement, 'domElement');
        var domElementChild = this._domElement.children.item(0);
        return domElementChild.scrollWidth;
    };
    ...
    MinimalWebPartContainer.prototype._renderWebPart = function (domElement) {
        ...
        return this._webPartManager.loadWebPart({
            ...
            displayMode: sp_core_library_["DisplayMode"].Read,
...
// module
exports.push([module.i, ".errorBox_50ec6a71{padding:12px 0;overflow:hidden;position:relative;top:0;left:0;right:0;z-index:1;display:inline-block}[dir=ltr] .errorBox_50ec6a71{text-align:left}[dir=rtl] .errorBox_50ec6a71{text-align:right}.errorBoxText_50ec6a71{position:relative;display:inline-block;white-space:pre-wrap;color:#666;font-weight:700}.detailsButton_50ec6a71{text-transform:uppercase;color:#0078d4;border:none;background:0 0;margin-top:20px}[dir=ltr] .detailsButton_50ec6a71{padding-left:0}[dir=rtl] .detailsButton_50ec6a71{padding-right:0}.somethingWentWrongText_50ec6a71{font-weight:400;color:#0078d4}.siteAdminText_50ec6a71{font-weight:700;color:#0078d4}.screenReaderOnly_50ec6a71{position:absolute;text-indent:-9999px;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;border:0}", ""]);
...
// module
exports.push([module.i, "@-webkit-keyframes spin_6416dc2d{0%{-webkit-transform:rotate(-45deg);transform:rotate(-45deg)}to{-webkit-transform:rotate(315deg);transform:rotate(315deg)}}@keyframes spin_6416dc2d{0%{-webkit-transform:rotate(-45deg);transform:rotate(-45deg)}to{-webkit-transform:rotate(315deg);transform:rotate(315deg)}}.spinnerContainer_6416dc2d{position:relative;width:100%;margin:164px 0}.spinner_6416dc2d{position:relative;width:20px;height:20px;margin:auto}.spinnerRing_6416dc2d,.spinnerSlice_6416dc2d{position:absolute}.spinnerRing_6416dc2d{z-index:0;color:\"[theme:themeLight, default: #c7e0f4]\"}.spinnerSlice_6416dc2d{z-index:10;color:\"[theme:themePrimary, default: #0078d4]\";-webkit-animation:spin_6416dc2d 1.5s infinite;animation:spin_6416dc2d 1.5s infinite;-webkit-animation-timing-function:easeInOutCirc;animation-timing-function:easeInOutCirc}.spinnerLoadingMessage_6416dc2d{margin-top:10px;text-align:center;color:\"[theme:themePrimary, default: #0078d4]\"}.spinnerAccessibilityMessage_6416dc2d{position:absolute;width:1px;height:1px;margin:-1px;padding:0;border-width:0;overflow:hidden}", ""]);
...
// module
exports.push([module.i, "[id^=spPropertyPaneContainer].showPane_415eb785{width:340px}[id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer_415eb785{position:absolute;top:50px;bottom:0;z-index:999}[dir=ltr] [id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer_415eb785{right:-340px}[dir=rtl] [id^=spPropertyPaneContainerNoFlexbox].spPropertyPaneContainer_415eb785{left:-340px}[dir=ltr] [id^=spPropertyPaneContainerNoFlexbox].showPane_415eb785{right:0}[dir=rtl] [id^=spPropertyPaneContainerNoFlexbox].showPane_415eb785{left:0}[dir=ltr] [id^=spPageChromeAppDiv].shrinkContent_415eb785{right:340px}[dir=rtl] [id^=spPageChromeAppDiv].shrinkContent_415eb785{left:340px}[dir=ltr] [id^=workbenchPageContent].shrinkContent_415eb785{right:340px}[dir=rtl] [id^=workbenchPageContent].shrinkContent_415eb785{left:340px}[dir=ltr] [id^=workbenchCommandBar].shrinkContent_415eb785{padding-right:340px}[dir=rtl] [id^=workbenchCommandBar].shrinkContent_415eb785{padding-left:340px}", ""]);
