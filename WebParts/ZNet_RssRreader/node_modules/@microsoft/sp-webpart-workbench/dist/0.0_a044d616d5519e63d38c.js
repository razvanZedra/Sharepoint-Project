webpackJsonp8be81a5c_af38_4bb2_af97_afa3b64dfbed_1_7_0([0],Array(317).concat([
/* 317 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Tooltip_index__ = __webpack_require__(359);
...
var ISpPageContext_1 = __webpack_require__(462);
var FeatureOverrides_1 = __webpack_require__(73);
var DataSource_1 = __webpack_require__(463);
var PrincipalType_1 = __webpack_require__(334);
var ApiUrlHelper_1 = __webpack_require__(468);
var ItemUrlHelper_1 = __webpack_require__(354);
var UserPhotoUrlHelper_1 = __webpack_require__(469);
var DataRequestor_1 = __webpack_require__(470);
var Error_1 = __webpack_require__(357);
var ABExperiment_1 = __webpack_require__(130);
var Killswitch_1 = __webpack_require__(66);
var EmailAddressParser_1 = __webpack_require__(474);
...
var PeoplePickerDataSource = /** @class */ (function (_super) {
    ...
    PeoplePickerDataSource.prototype.canUseGraph = function (context) {
        var canUseGraph = context && context.useGraph && this._graphPeoplePickerHelper && this._graphPeoplePickerHelper.canUseGraph();
        if (canUseGraph && !this._dataRequestor) {
            this._dataRequestor = new DataRequestor_1.default({}, {});
        }
        return canUseGraph;
    };
    PeoplePickerDataSource.prototype.search = function (query, context) {
        if (this.canUseGraph(context)) {
    ...
    PeoplePickerDataSource.prototype._graphSearch = function (query, context) {
        ...
        return this._graphPeoplePickerHelper.getGraphToken().then(function (oAuthToken) {
             ...
             */
            var graphRequestUrl = new Uri_1.default("https://graph.microsoft.com/v1.0/me/people");
            if (query) {
                ...
                graphRequestUrl.setQueryFromObject({
                    ...
                    $filter: isExperimentOn ? undefined : 'personType/subclass ne \'PublicDistributionList\''
                });
            }
            return _this._dataRequestor.send({
                ...
                rawPeople.forEach(function (rawPerson) {
                    ...
                    var person = {
                        ...
                        email: email,
                        image: isImplicit ? undefined : UserPhotoUrlHelper_1.getUserPhotoUrl({ userLoginName: email }),
                        job: rawPerson.jobTitle || email,
                        name: rawPerson.displayName,
                        providerName: !isOrganizationUser ? undefined : 'Provider',
                        userId: rawPerson.userPrincipalName && _this._isValidEmail(rawPerson.userPrincipalName, false /*isSecurityGroup*/) ? rawPerson.userPrincipalName : email,
                        rawData: rawData,
                        rawPersonData: rawData,
    ...
    PeoplePickerDataSource.prototype._transformData = function (data, filterExternalUsers) {
        ...
        return data.map(function (rawPerson) {
            ...
            /**
             * If this._imageAbsoluteWebURL is set, it means that url should prepend the normal image URL
             */
            var email = person.email;
            if (person.isResolved) {
                if (email) {
                    person.image = _this._imageAbsoluteWebUrl + UserPhotoUrlHelper_1.getUserPhotoUrl({ userLoginName: email });
                }
                else {
                    person.image = null;
                }
...
Object.defineProperty(exports, "__esModule", { value: true });
var PairedEventBase_1 = __webpack_require__(129);
var Qos_event_1 = __webpack_require__(34);
var ResultTypeEnum_1 = __webpack_require__(127);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var SimpleUri_1 = __webpack_require__(120);
var StringHelper_1 = __webpack_require__(68);
var ItemUrlHelperBasic_1 = __webpack_require__(355);
var AddressParser_1 = __webpack_require__(72);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var UriEncoding_1 = __webpack_require__(46);
/**
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Tooltip__ = __webpack_require__(132);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tooltip_base__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TooltipHost__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__TooltipHost_types__ = __webpack_require__(135);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common_DirectionalHint__ = __webpack_require__(362);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_pickers_index__ = __webpack_require__(397);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Suggestions_Suggestions__ = __webpack_require__(341);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Suggestions_SuggestionsController__ = __webpack_require__(342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__AutoFill_BaseAutoFill__ = __webpack_require__(404);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__BasePicker__ = __webpack_require__(332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BasePicker_types__ = __webpack_require__(319);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__PeoplePicker_PeoplePicker__ = __webpack_require__(420);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TagPicker_TagPicker__ = __webpack_require__(455);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TagPicker_TagItem__ = __webpack_require__(350);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Spinner__ = __webpack_require__(400);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Suggestions_scss__ = __webpack_require__(401);
...
var Suggestions = /** @class */ (function (_super) {
    ...
    Suggestions.prototype._renderSuggestions = function () {
        ...
        return (__WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { className: Object(__WEBPACK_IMPORTED_MODULE_2__Utilities__["css"])('ms-Suggestions-container', styles.suggestionsContainer, suggestionsClassName), id: suggestionsListId, role: 'listbox', "aria-label": suggestionsContainerAriaLabel }, suggestions.map(function (suggestion, index) {
            return __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { ref: suggestion.selected ? _this._selectedElement : '', 
                ...
                __WEBPACK_IMPORTED_MODULE_1_react__["createElement"](TypedSuggestionsItem, { suggestionModel: suggestion, RenderSuggestion: onRenderSuggestion, onClick: _this._onClickTypedSuggestionsItem(suggestion.item, index), className: suggestionsItemClassName, showRemoveButton: showRemoveButtons, removeButtonAriaLabel: removeSuggestionAriaLabel, onRemoveItem: _this._onRemoveTypedSuggestionsItem(suggestion.item, index) }));
        })));
    };
    return Suggestions;
}(__WEBPACK_IMPORTED_MODULE_2__Utilities__["BaseComponent"]));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Autofill_Autofill__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utilities_selection_index__ = __webpack_require__(408);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Suggestions_Suggestions__ = __webpack_require__(341);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Suggestions_SuggestionsController__ = __webpack_require__(342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BasePicker_types__ = __webpack_require__(319);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Autofill_index__ = __webpack_require__(416);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__BasePicker_scss__ = __webpack_require__(418);
...
var BasePicker = /** @class */ (function (_super) {
    ...
    BasePicker.prototype.getSuggestionsAlert = function () {
        ...
        if (this.props.enableSelectedSuggestionAlert) {
            ...
            return (__WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { className: styles.screenReaderOnly, role: 'alert', id: this._ariaMap.selectedSuggestionAlert, "aria-live": 'assertive' },
...
var BasePickerListBelow = /** @class */ (function (_super) {
    ...
    BasePickerListBelow.prototype.render = function () {
        ...
        var selectedSuggestionAlertId = this.props.enableSelectedSuggestionAlert
            ...
            : '';
        var suggestionsAvailable = this.state.suggestionsVisible ? this._ariaMap.suggestionList : '';
        return (__WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { ref: this.root },
            __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { className: Object(__WEBPACK_IMPORTED_MODULE_2__Utilities__["css"])('ms-BasePicker', className ? className : ''), onKeyDown: this.onKeyDown },
                this.getSuggestionsAlert(),
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interfaces__ = __webpack_require__(333);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Selection__ = __webpack_require__(411);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SelectionZone__ = __webpack_require__(413);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Utilities__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__interfaces__ = __webpack_require__(333);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Autofill__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BasePicker_types__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BasePicker_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__BasePicker_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__PeoplePickerItems_SelectedItemDefault__ = __webpack_require__(422);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__PeoplePickerItems_SuggestionItemDefault__ = __webpack_require__(452);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__PeoplePicker_scss__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Utilities__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Persona__ = __webpack_require__(344);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BasePicker_types__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BasePicker_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__BasePicker_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Button__ = __webpack_require__(117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__PickerItemsDefault_scss__ = __webpack_require__(450);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Persona_index__ = __webpack_require__(425);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Persona__ = __webpack_require__(427);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Persona_base__ = __webpack_require__(345);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Persona_types__ = __webpack_require__(317);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PersonaCoin_index__ = __webpack_require__(448);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__PersonaConsts__ = __webpack_require__(318);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Persona_base__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Persona_base___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Persona_base__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Persona_styles__ = __webpack_require__(446);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Utilities__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Tooltip__ = __webpack_require__(430);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__PersonaCoin_PersonaCoin__ = __webpack_require__(346);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Persona_types__ = __webpack_require__(317);
...
var PersonaBase = /** @class */ (function (_super) {
    ...
    PersonaBase.prototype._renderElement = function (classNames, renderFunction, defaultRenderFunction) {
        return __WEBPACK_IMPORTED_MODULE_1_react__["createElement"]("div", { className: classNames }, renderFunction && renderFunction(this.props, defaultRenderFunction));
    };
    /**
    ...
    PersonaBase.prototype._onRenderText = function (text) {
        ...
        return text
            ? function () {
                ...
                return (__WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_3__Tooltip__["TooltipHost"], { content: text, overflowMode: __WEBPACK_IMPORTED_MODULE_3__Tooltip__["TooltipOverflowMode"].Parent, directionalHint: 0 /* topLeftEdge */ }, text));
            }
            : undefined;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utilities__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utilities___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Utilities__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PersonaCoin_base__ = __webpack_require__(347);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PersonaCoin_styles__ = __webpack_require__(444);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__PersonaPresence_index__ = __webpack_require__(433);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Icon__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Icon___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__Icon__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Image__ = __webpack_require__(338);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Persona_types__ = __webpack_require__(317);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__PersonaInitialsColor__ = __webpack_require__(442);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PersonaPresence__ = __webpack_require__(435);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PersonaPresence_base__ = __webpack_require__(348);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PersonaPresence_base__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PersonaPresence_base___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__PersonaPresence_base__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PersonaPresence_styles__ = __webpack_require__(440);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utilities___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Utilities__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Icon__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Icon___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__Icon__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Persona_types__ = __webpack_require__(317);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__PersonaConsts__ = __webpack_require__(318);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Persona_types__ = __webpack_require__(317);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PersonaConsts__ = __webpack_require__(318);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PersonaCoin__ = __webpack_require__(346);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Persona__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Persona___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__Persona__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__PeoplePicker_scss__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__BasePicker__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__BasePicker___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__BasePicker__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__TagItem__ = __webpack_require__(350);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__TagItem_scss__ = __webpack_require__(351);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Utilities__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Utilities___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Utilities__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Icon__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Icon___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Icon__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TagItem_scss__ = __webpack_require__(351);
...
// module
exports.push([module.i, ".mentionSuggestions_3b8160f5{min-width:100%}.mentionField_3b8160f5 a[data-sp-mention-user-id]{color:\"[theme:themeTertiary, default:#71afe5]\";font-weight:lighter}.mentionField_3b8160f5 a[data-sp-mention-user-id]:not([access-type=\"0\"]){color:\"[theme:themePrimary, default:#0078d4]\";font-weight:700}", ""]);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(0);
var DataRequestor_1 = __webpack_require__(464);
...
var Retry_1 = __webpack_require__(465);
var Qos_event_1 = __webpack_require__(34);
var Api_event_1 = __webpack_require__(353);
var RUMOneLogger_1 = __webpack_require__(45);
var ServerConnection_1 = __webpack_require__(466);
var Killswitch_1 = __webpack_require__(66);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Signal_1 = __webpack_require__(69);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var ServerData_1 = __webpack_require__(467);
var UriEncoding_1 = __webpack_require__(46);
var Uri_1 = __webpack_require__(65);
var Scope_1 = __webpack_require__(47);
var APICallPerformanceData_1 = __webpack_require__(128);
var RUMOneLogger_1 = __webpack_require__(45);
var EventGroup_1 = __webpack_require__(131);
var Promise_1 = __webpack_require__(27);
...
var tslib_1 = __webpack_require__(0);
var ItemUrlHelper_1 = __webpack_require__(354);
var ApiUrlHelperBasic_1 = __webpack_require__(356);
...
/**
 * @author Joshua Gui (jogui)
 * @fileOverview UserPhotoUrlHelper.ts: Generates the URL for a user's profile photo
 */
Object.defineProperty(exports, "__esModule", { value: true });
var UserPhotoSize;
(function (UserPhotoSize) {
    UserPhotoSize["Small"] = "S";
    UserPhotoSize["Medium"] = "M";
    UserPhotoSize["Large"] = "L"; // 300 px
})(UserPhotoSize = exports.UserPhotoSize || (exports.UserPhotoSize = {}));
function getUserPhotoUrl(photoUrlParams) {
    var webUrl = photoUrlParams.webUrl || '';
    var photoSizeParam = photoUrlParams.size || UserPhotoSize.Small;
    return webUrl + "/_layouts/15/userphoto.aspx?accountname=" + photoUrlParams.userLoginName + "&size=" + photoSizeParam;
}
...
var tslib_1 = __webpack_require__(0);
var Promise_1 = __webpack_require__(27);
var XHRPromise_1 = __webpack_require__(471);
var Api_event_1 = __webpack_require__(353);
var Qos_event_1 = __webpack_require__(34);
var Uri_1 = __webpack_require__(65);
var Error_1 = __webpack_require__(357);
var DataRequestor = /** @class */ (function () {
    function DataRequestor(params, dependencies) {
        var sessionManagementProvider = dependencies.sessionManagementProvider, urlDataSource = dependencies.urlDataSource;
        this._sessionManagementProvider = sessionManagementProvider;
        this._apiName = urlDataSource && typeof (urlDataSource.getApiName) === "function" ?
            urlDataSource.getApiName() :
            "Vroom";
    ...
    DataRequestor.prototype.send = function (options) {
        var _this = this;
        var _a = options.headers, headers = _a === void 0 ? {} : _a, path = options.path, apiName = options.apiName, _b = options.requestType, requestType = _b === void 0 ? 'GET' : _b, _c = options.disableLogging, disableLogging = _c === void 0 ? false : _c, timeout = options.timeout, onProgress = options.onProgress, onUploadProgress = options.onUploadProgress, qosExtraData = options.qosExtraData, _d = options.apiVersion, apiVersion = _d === void 0 ? 'v2.0' : _d, _e = options.needsAuthorization, needsAuthorization = _e === void 0 ? true : _e, _f = options.useAuthorizationHeaders, useAuthorizationHeaders = _f === void 0 ? false : _f, accessToken = options.accessToken, postProcessQos = options.postProcessQos;
        var sessionManagementProvider = this._sessionManagementProvider;
        var getAccessToken = needsAuthorization && (accessToken || sessionManagementProvider && sessionManagementProvider.getToken(apiVersion).catch(function (error) {
            // Treat auth failures as a client-side service interruption.
            return Promise_1.default.reject(new Error_1.GraphError(error, {
                status: 0,
                response: {
                    error: {
                        code: 'authFailure'
        ...
        return Promise_1.default.resolve(getAccessToken).then(function (sessionToken) {
            var apiBaseUrl = _this._apiBaseUrl;
            // Don't pass a content-type header if no postData. Otherwise we are stuck with CORS pre-flight on all requests.
            var requestHeaders = tslib_1.__assign({ 'Accept': 'application/json' }, (options.postData ? {
                'Content-Type': 'application/json'
            } : {}), headers);
            var apiUri;
            if (sessionToken && sessionToken.tokenUrl && path.indexOf("/drive/") === 0) {
                // replace the generic "/drive/" with our specific token url
                apiUri = new Uri_1.default(sessionToken.tokenUrl + "/" + path.substring(7));
            }
            else {
                apiUri = new Uri_1.default(path);
                if (apiBaseUrl && !apiUri.getScheme()) {
                    apiUri = new Uri_1.default(apiBaseUrl + path);
                }
            }
            // save the url to log before we add sensitive tokens
            var apiUrlToLog = apiUri.toString();
            if (sessionToken) {
                var sessionAccessToken = sessionToken.accessToken, proofToken = sessionToken.proofToken, wlidToken = sessionToken.wlidToken;
                if (wlidToken) {
                    requestHeaders = tslib_1.__assign({}, requestHeaders, { 'Authorization': "wlid1.1 " + wlidToken });
                }
                else if (useAuthorizationHeaders) {
                    if (sessionAccessToken) {
                        requestHeaders = tslib_1.__assign({}, requestHeaders, { 'Authorization': "bearer " + sessionAccessToken });
                    }
                    if (proofToken) {
                        requestHeaders = tslib_1.__assign({}, requestHeaders, { 'X-PROOF_TOKEN': proofToken });
                    }
                }
                else {
                    if (sessionAccessToken) {
            ...
            var apiEvent;
            if (!disableLogging) {
                apiEvent = new Api_event_1.Api({
                    url: apiUrlToLog,
                    name: _this._apiName + "DataRequest." + apiName,
                    extraData: qosExtraData
                });
            }
            return XHRPromise_1.default.start({
                url: apiUri.toString(),
                ...
                if (request instanceof Error) {
                    var resultType = Promise_1.default.isCanceled(request) ? Qos_event_1.ResultTypeEnum.ExpectedFailure : Qos_event_1.ResultTypeEnum.Failure;
                    apiEndSchema = {
                    ...
                    var status_1 = request.status, statusText = request.statusText;
                    var _a = (response || {}).error, _b = _a === void 0 ? {} : _a, _c = _b.message, message = _c === void 0 ? '' : _c, _d = _b.innererror, _e = _d === void 0 ? {} : _d, _f = _e.stackTrace, stackTrace = _f === void 0 ? '' : _f, _g = _e.debugMessage, debugMessage = _g === void 0 ? '' : _g;
                    error = new Error_1.GraphError(new Error(message), {
                        response: response,
                        status: status_1,
                        request: request
                    });
                    var resultCode = Error_1.getResultCodeFromError(error);
                    apiEndSchema = {
                        resultType: Qos_event_1.ResultTypeEnum.Failure,
                        error: message,
                        resultCode: resultCode,
                        extraData: tslib_1.__assign({}, (qosExtraData || {}), Error_1.getQosExtraDataFromError(error), { stack: stackTrace, httpStatus: status_1, httpStatusText: statusText, requestId: request.getResponseHeader("request-id") || request.getResponseHeader("sprequestguid"), debugMessage: debugMessage, accessTokenLength: (sessionToken && sessionToken.accessToken) ? sessionToken.accessToken.length : -1, urlLength: apiUri.toString().length })
                    };
                }
                if (postProcessQos) {
...
// OneDrive:IgnoreCodeCoverage
Object.defineProperty(exports, "__esModule", { value: true });
var XHR_1 = __webpack_require__(71);
var Promise_1 = __webpack_require__(27);
var XHRPromise = /** @class */ (function () {
    function XHRPromise() {
    }
    XHRPromise.start = function (options) {
        var xhr = new XHR_1.default(options);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Promise_1 = __webpack_require__(27);
var PeoplePickerDataSource_1 = __webpack_require__(352);
var PeopleStore_1 = __webpack_require__(478);
...
// EXTERNAL MODULE: C:/agent/1/_work/30/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/@ms/odsp-utilities-bundle/4.5.2/node_modules/@ms/odsp-utilities-bundle/lib/index.js
var lib = __webpack_require__(17);
var lib_default = /*#__PURE__*/__webpack_require__.n(lib);

// EXTERNAL MODULE: C:/agent/1/_work/30/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.131.0/react-dom@16.3.2+react@16.3.2/node_modules/office-ui-fabric-react/lib/Tooltip.js
var Tooltip = __webpack_require__(358);
...
// CONCATENATED MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/DeferredCoachmarkHost.js


var DeferredCoachmarkHost_DeferredCoachmarkHost = (function (_super) {
    tslib_es6["__extends"](DeferredCoachmarkHost, _super);
    function DeferredCoachmarkHost() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DeferredCoachmarkHost.prototype._internalLoad = function () {
        return __webpack_require__.e/* import() */(7).then(__webpack_require__.bind(null, 548)).then(function (atMentionControl) { return atMentionControl.default; });
    };
    return DeferredCoachmarkHost;
}(sp_webpart_base_["_DeferredComponent"]));
/* harmony default export */ var AtMention_DeferredCoachmarkHost = (DeferredCoachmarkHost_DeferredCoachmarkHost);

// EXTERNAL MODULE: C:/agent/1/_work/30/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/5.131.0/react-dom@16.3.2+react@16.3.2/node_modules/office-ui-fabric-react/lib/Pickers.js
var Pickers = __webpack_require__(395);
var Pickers_default = /*#__PURE__*/__webpack_require__.n(Pickers);

// CONCATENATED MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/MentionPeoplePicker.module.scss.js
__webpack_require__(459);
var styles = {
    mentionSuggestions: 'mentionSuggestions_3b8160f5',
    mentionField: 'mentionField_3b8160f5',
};
/* harmony default export */ var MentionPeoplePicker_module_scss = (styles);

// CONCATENATED MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/AtMentionInput.js
...
var AtMentionInput_AtMentionInput = (function () {
    function AtMentionInput(target) {
        ...
        this._inputElement.current.classList.add(MentionPeoplePicker_module_scss.mentionField);
    }
    ...
    AtMentionInput.prototype.setAriaLabels = function (ariaLabels) {
        var _this = this;
        ariaLabels.forEach(function (ariaLabel) {
            if (ariaLabel.label === undefined) {
                _this._inputElement.current.removeAttribute("aria-" + ariaLabel.attr);
            }
            else {
                _this._inputElement.current.setAttribute("aria-" + ariaLabel.attr, ariaLabel.label.toString());
            }
        });
    };
...
// CONCATENATED MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/MentionPeoplePicker.js
...
var MentionPeoplePicker_MentionPeoplePicker = (function (_super) {
    ...
    MentionPeoplePicker.prototype.render = function () {
        return (external__react_["createElement"]("div", { ref: this._resolveRef('root') },
            this.renderSuggestions(),
            this.props.children));
    };
    ...
    MentionPeoplePicker.prototype.componentDidUpdate = function () {
        var isVisible = this.state.suggestionsVisible;
        this.input.current.setAriaLabels([
            { attr: 'activedescendant', label: isVisible ? "sug-" + this.suggestionStore.currentIndex : undefined },
            { attr: 'owns', label: 'suggestion-list' },
            { attr: 'expanded', label: isVisible },
            { attr: 'haspopup', label: isVisible }
        ]);
    };
    MentionPeoplePicker.prototype.handleKeyDown = function (ev) {
        if (this.state.suggestionsVisible) {
            var keyCode = ev.keyCode, shiftKey = ev.shiftKey;
            switch (keyCode) {
                case 9 :
                case 13 :
...
// EXTERNAL MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/a11y/RteA11y.js + 1 modules
var RteA11y = __webpack_require__(49);

// EXTERNAL MODULE: C:/agent/1/_work/30/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/@ms/odsp-datasources/33.33.2/node_modules/@ms/odsp-datasources/lib/PeoplePicker.js
var PeoplePicker = __webpack_require__(461);
var PeoplePicker_default = /*#__PURE__*/__webpack_require__.n(PeoplePicker);

// EXTERNAL MODULE: C:/agent/1/_work/30/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/@ms/odsp-datasources/33.33.2/node_modules/@ms/odsp-datasources/lib/dataSources/roleAssignments/PrincipalType.js
var PrincipalType = __webpack_require__(334);
var PrincipalType_default = /*#__PURE__*/__webpack_require__.n(PrincipalType);

// EXTERNAL MODULE: external "@microsoft/sp-http"
var sp_http_ = __webpack_require__(315);
var sp_http__default = /*#__PURE__*/__webpack_require__.n(sp_http_);

// CONCATENATED MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/PermissionDataProvider.js
...
var PermissionDataProvider_PermissionDataProvider = (function () {
    function PermissionDataProvider(serviceScope) {
        ...
        if (this._pageContext.list && this._pageContext.listItem) {
            ...
            this._permissionEndPoint = "_api/web/Lists('" + listId + "')/GetItemById('" + itemId + "')/";
        }
    ...
    PermissionDataProvider.prototype._postRequest = function (method, body) {
        var postUrl = lib["Uri"].concatenate(this._webAbsoluteUrl, this._permissionEndPoint, method);
...
// CONCATENATED MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/RelevantPeopleDataProvider.js


var RelevantPeopleDataProvider_RelevantPeopleDataProvider = (function () {
    function RelevantPeopleDataProvider(serviceScope) {
        this._relevanceEndPoint = new lib["Uri"]('v1.0/me/people');
        this._idRegex = /.+\|.+\|.+/;
        this._httpClient = serviceScope.consume(sp_http_["GraphHttpClient"].serviceKey);
    }
    RelevantPeopleDataProvider.prototype.getRelevantPeople = function (queryObj) {
        var _this = this;
        if (queryObj) {
            this._relevanceEndPoint.setQueryFromObject(queryObj);
        }
        var url = this._relevanceEndPoint.toString();
        if (url.charAt(0) === '/') {
            url = url.substr(1);
        }
        return this._httpClient
            .get(url, sp_http_["GraphHttpClient"].configurations.v1, {
            headers: this._headers
        })
            .then(function (response) { return response.json(); })
            .then(function (json) {
            if (json.value) {
                return json.value.map(function (value) {
                    var emailAccount = value.userPrincipalName || value.scoredEmailAddresses[0].address;
                    var userId = _this._idRegex.test(emailAccount)
                        ? emailAccount
                        : "i:0#.f|membership|" + emailAccount;
                    return {
                        userId: userId,
                        ...
                        image: emailAccount ? "/_layouts/15/userphoto.aspx?accountname=" + emailAccount + "&size=S" : undefined
                    };
                });
            }
            else {
    ...
    return RelevantPeopleDataProvider;
}());
/* harmony default export */ var AtMention_RelevantPeopleDataProvider = (RelevantPeopleDataProvider_RelevantPeopleDataProvider);

// EXTERNAL MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/loc/AtMention.resx.js
var AtMention_resx = __webpack_require__(340);

// CONCATENATED MODULE: C:/agent/1/_work/30/s/libraries/sp-canvas/lib/sp-rte/rte/AtMention/AtMentionControl.js
...
var TEXT_NODE = '#text';
var PERMISSION_MONITOR = 'AtMention.VerifyAccess';
var PICKER_MONITOR = 'AtMention.PeoplePicker';
var RELEVANCE_MONITOR = 'AtMention.RelevanceSearch';
var MENTION_COACHMARK_DISMISSED_KEY = 'DismissedMentionCoachmark';
var AtMentionControl_AtMentionControl = (function (_super) {
    tslib_es6["__extends"](AtMentionControl, _super);
    function AtMentionControl(props) {
        var _this = _super.call(this, props) || this;
        ...
        _this._graphDataProvider = new AtMention_RelevantPeopleDataProvider(_this.props.serviceScope);
        _this._newMentionNode = document.createElement('a');
        _this._relevantUsers = [];
        _this._coachmarkDismissed = !!window.localStorage.getItem(MENTION_COACHMARK_DISMISSED_KEY);
        _this.state = {
            mentionQuery: ''
        };
        return _this;
    }
    AtMentionControl._shortenDisplayName = function (nameElement) {
        var currentName = nameElement.innerText;
        if (AtMentionControl.BRACKET_REGEX.test(currentName)) {
            currentName = currentName.replace(AtMentionControl.BRACKET_REGEX, '');
        }
        else {
            if (AtMentionControl.LAST_NAME_SECTION_REGEX.test(currentName)) {
                currentName = currentName.replace(AtMentionControl.LAST_NAME_SECTION_REGEX, '');
            }
            else {
                currentName = '';
                nameElement.remove ? nameElement.remove() : nameElement.parentElement.removeChild(nameElement);
    ...
    AtMentionControl._isMentionAnchor = function (nameElement) {
        return !!(nameElement &&
            nameElement.nodeName === 'A' &&
            nameElement.getAttribute("data-sp-mention-user-id" ));
    };
    AtMentionControl.prototype.render = function () {
        var enableSearchDirectory = this._isGraphAPISupported &&
            this.state.mentionQuery !== AtMentionControl.RELEVANT_USER_QUERY &&
            this.state.mentionQuery.length >= MIN_QUERY_LENGTH;
        var suggestionProps = {
            className: MentionPeoplePicker_module_scss.mentionSuggestions,
            loadingText: AtMention_resx["a" /* default */].loadingText,
            suggestionsHeaderText: enableSearchDirectory ? undefined : AtMention_resx["a" /* default */].moreCharactersText,
            noResultsFoundText: AtMention_resx["a" /* default */].noResultsFoundText,
            suggestionsAvailableAlertText: AtMention_resx["a" /* default */].suggestionsAvailableAlertText,
            suggestionsContainerAriaLabel: AtMention_resx["a" /* default */].suggestionsContainerAriaLabel,
            searchForMoreText: enableSearchDirectory ? AtMention_resx["a" /* default */].searchDirectory : undefined
        };
        var tooltipText = this.state.lastInvalidMention ? this.state.lastInvalidMention.innerText : '';
        if (tooltipText.length > 0 && tooltipText[0] === '@') {
            tooltipText = tooltipText.substr(1);
        }
        return (external__react_["createElement"](AtMention_MentionPeoplePicker, { onResolveSuggestions: this._handleResolveSuggestions, onRenderSuggestionsItem: this._onRenderSuggestionItem, 
            getTextFromItem: this._getTextFromItem, pickerSuggestionsProps: suggestionProps, className: "ms-PeoplePicker", componentRef: this._resolveRef('_picker'), resolveDelay: 300, mentionQuery: this.state.mentionQuery, calloutTarget: this.props.editorElement, onItemSelected: this._onPersonaSelected, onGetMoreResults: this._onGetMoreResults, dataSource: this._dataSource }, tooltipText && (external__react_["createElement"](Tooltip["Tooltip"], { targetElement: this.state.lastInvalidMention, onRenderContent: function () {
                return external__react_["createElement"]("span", null, sp_core_library_["Text"].format(AtMention_resx["a" /* default */].noPermissionText, tooltipText));
            }, onClick: this._dissmissTooltip, onMouseLeave: this._dissmissTooltip }))));
    };
    AtMentionControl.prototype.shouldComponentUpdate = function (newProps, newState) {
        return (this.state.lastInvalidMention !== newState.lastInvalidMention || this._lastResolvedQuery !== newState.mentionQuery);
    };
    AtMentionControl.prototype.componentDidMount = function () {
        var _this = this;
        ...
        var relevancePeopleMonitor = new sp_telemetry_["_QosMonitor"](RELEVANCE_MONITOR);
        this._graphDataProvider
            .getRelevantPeople()
            .then(function (users) {
            _this._relevantUsers = users;
            _this._isGraphAPISupported = true;
            if (!_this._peoplePickerSearchPromise) {
                _this._handleMention();
            }
            relevancePeopleMonitor.writeSuccess();
        })
            .catch(function (error) {
            _this._isGraphAPISupported = false;
            relevancePeopleMonitor.writeUnexpectedFailure('RelevanceSearch Graph service failure', error);
        });
        if (!sp_core_library_["_SPKillSwitch"].isActivated(sp_core_library_["Guid"].parse('f2eb4536-fd20-40e2-ad82-6ed90a4765b6'), '10/18/2018', 'Disabling coachmark and update placeholder instead')) {
            this._updatePlaceHolder();
        }
        else if (!this._coachmarkDismissed) {
            this._loadAndShowCoachmark();
        }
    };
    AtMentionControl.prototype.componentWillUnmount = function () {
    ...
    AtMentionControl.prototype.getMentionData = function () {
        var mentionQuery = '';
        var nodeText = '';
        var currentNode;
        var lastAtIndex = -1;
        var caretRange = this._caretRange;
        if (caretRange && caretRange.endContainer.nodeName === TEXT_NODE) {
            ...
            if (lastAtIndex === 0 || (lastAtIndex > 0 && this._isTerminatingCharacter(nodeText[lastAtIndex - 1]))) {
                mentionQuery = nodeText.substring(lastAtIndex + 1, caretRange.endOffset).trim();
                if (mentionQuery === '') {
                    mentionQuery = AtMentionControl.RELEVANT_USER_QUERY;
                }
            }
    ...
    AtMentionControl.prototype.getMentionsTotal = function (withPermission) {
        if (withPermission === true) {
            return this._mentionCountWithPermission;
        }
        else if (withPermission === false) {
            return this._mentionCountWithoutPermission;
        }
        else {
            return this._mentionCount;
        }
    };
    AtMentionControl.prototype._handleMention = function (ev) {
        var _this = this;
        var _a = this.getMentionData(), currentNode = _a.currentNode, mentionQuery = _a.mentionQuery;
        if (mentionQuery !== this.state.mentionQuery && !(ev && ev.which === 27 )) {
            this.setState({
                currentNode: currentNode,
                mentionQuery: mentionQuery
            });
    ...
    AtMentionControl.prototype._transformMentionQuery = function (person) {
        var caretRange = this._caretRange;
        ...
        if (mentionQuery.length > 0) {
            ...
            newMentionNode.setAttribute("data-sp-mention-user-id" , userId);
            newMentionNode.setAttribute('contenteditable', 'false');
            newMentionNode.setAttribute("access-type" , "?" );
            newMentionNode.appendChild(document.createTextNode(sp_core_library_["Text"].format(AtMention_resx["a" /* default */].mentionLink, name)));
            ...
            Object(RteA11y["a" /* ariaAlert */])(sp_core_library_["Text"].format(AtMention_resx["a" /* default */].mentionAlertMessage, name));
            this._verifyAccess(email, newMentionNode);
            this._mentionCount += 1;
        }
    };
    AtMentionControl.prototype._verifyAccess = function (email, newMentionNode) {
        var _this = this;
        if (this._sharedUsers && this._sharedUsers.has(email)) {
            return;
        }
        var permissionMonitor = new sp_telemetry_["_QosMonitor"](PERMISSION_MONITOR);
        this._permissionProvider
            .checkPermission(email)
            .then(function (response) {
            if (response.value && response.value.length > 0) {
                var accessType = response.value[0].existingAccessType.toString();
                newMentionNode.setAttribute("access-type" , accessType);
                if (accessType === "0" ) {
                    _this.setState({ lastInvalidMention: newMentionNode });
                    if (_this._tooltipTimeout) {
                        clearTimeout(_this._tooltipTimeout);
                    }
                    _this._tooltipTimeout = setTimeout(function () {
                        _this._dissmissTooltip();
                    }, 10000);
                    permissionMonitor.writeExpectedFailure('MentionWithoutPermission');
                    _this._mentionCountWithoutPermission += 1;
                }
                else {
                    permissionMonitor.writeSuccess();
                    _this._mentionCountWithPermission += 1;
                }
            }
        })
            .catch(function (error) {
            permissionMonitor.writeUnexpectedFailure('PermissionServiceFailure', error);
            return lib["Promise"].reject(error);
        });
    };
    AtMentionControl.prototype._dissmissTooltip = function () {
        if (this.state.lastInvalidMention) {
            this.setState({ lastInvalidMention: undefined });
        }
    };
    AtMentionControl.prototype._handleFilterChanged = function (persons, query) {
        return persons.filter(function (person) {
            return person.name.indexOf(query) === 0 || person.email.split('@')[0].indexOf(query) === 0;
        });
    };
    AtMentionControl.prototype._onPersonaSelected = function (person) {
        this._transformMentionQuery(person);
        this._dismissCoachmark();
        return person;
    };
    AtMentionControl.prototype._getTextFromItem = function (persona) {
        return persona.primaryText;
    };
    AtMentionControl.prototype._handleKeydown = function (ev) {
    ...
    AtMentionControl.prototype._processBackSpace = function () {
        ...
        if (this._selection.isCollapsed) {
            ...
            if (AtMentionControl._isMentionAnchor(nameElement)) {
                nameElement = AtMentionControl._shortenDisplayName(nameElement);
                if (nameElement && nameElement.getAttribute("access-type" ) === "0" ) {
                    this.setState({ lastInvalidMention: nameElement });
                }
                else {
                    this.setState({ lastInvalidMention: undefined });
                }
    ...
    AtMentionControl.prototype._skipZeroWidthSpace = function (currentPos) {
        if (!this._selection) {
            return;
        }
        if (this._selection.isCollapsed &&
    ...
    AtMentionControl.prototype._normalizeContent = function () {
        this.props.editorElement.normalize();
        var anchorNode = this._selection ? this._selection.anchorNode : undefined;
        if (anchorNode &&
            anchorNode.nodeName !== TEXT_NODE &&
    ...
    Object.defineProperty(AtMentionControl.prototype, "_selection", {
        get: function () {
    ...
    Object.defineProperty(AtMentionControl.prototype, "_caretRange", {
        get: function () {
    ...
    AtMentionControl.prototype._isTerminatingCharacter = function (lastChar) {
        return /\s/.test(lastChar);
    };
    AtMentionControl.prototype._handleResolveSuggestions = function (value) {
        var _this = this;
        if (this._peoplePickerSearchPromise) {
            this._peoplePickerSearchPromise.cancel();
            this._peoplePickerSearchPromise = undefined;
            if (this._pickerMonitor) {
                this._pickerMonitor.writeExpectedFailure('PickerActionCancelled');
                this._pickerMonitor = undefined;
            }
        }
        if (!value) {
            this._lastResolvedQuery = '';
            return [];
        }
        else if (this.state.mentionQuery === AtMentionControl.RELEVANT_USER_QUERY) {
            this._lastResolvedQuery = AtMentionControl.RELEVANT_USER_QUERY;
            return this._relevantUsers;
        }
        else if (value.length < MIN_QUERY_LENGTH) {
            this._lastResolvedQuery = this.state.mentionQuery;
            return this._handleFilterChanged(this._relevantUsers, value);
        }
        var peoplePickerSearchResult;
        if (this._isGraphAPISupported) {
            peoplePickerSearchResult = {
                promise: this._graphDataProvider.getRelevantPeople({
                    $search: "\"" + value + "\"",
                    $top: '30',
                    $select: 'displayName,scoredEmailAddresses,personType,department,jobTitle,userPrincipalName',
                    $filter: "personType/subclass ne 'PublicDistributionList'"
                }),
                cached: undefined
            };
        }
        else {
            peoplePickerSearchResult = this._dataProvider.search(value.trim(), this._getPeoplePickerQueryParams());
        }
        if (!peoplePickerSearchResult) {
            return this._handleFilterChanged ? this._handleFilterChanged([], value) : [];
        }
        return this._resolvePeoplePickerSearch(peoplePickerSearchResult).then(function (personList) {
            _this._lastResolvedQuery = value;
            return personList;
        });
    };
    AtMentionControl.prototype._onGetMoreResults = function (filter, selectedItems) {
        var _this = this;
        if (filter.length < MIN_QUERY_LENGTH) {
            return [];
        }
        var peoplePickerSearchResult = this._dataProvider.search(filter.trim(), this._getPeoplePickerQueryParams());
        return this._resolvePeoplePickerSearch(peoplePickerSearchResult).then(function (personList) {
            _this._lastResolvedQuery = filter;
            return personList;
        });
    };
    AtMentionControl.prototype._resolvePeoplePickerSearch = function (peoplePickerSearchResult) {
        var _this = this;
        var cachedItems = peoplePickerSearchResult.cached || [];
        this._peoplePickerSearchPromise = peoplePickerSearchResult.promise;
        this._pickerMonitor = new sp_telemetry_["_QosMonitor"](PICKER_MONITOR);
        return this._peoplePickerSearchPromise
            .then(function (personList) {
            _this._peoplePickerSearchPromise = undefined;
            _this._pickerMonitor.writeSuccess();
            _this._pickerMonitor = undefined;
            return personList ? cachedItems.concat(personList) : [];
        })
            .catch(function (error) {
            _this._pickerMonitor.writeUnexpectedFailure('PickerServiceFailure', error);
            _this._pickerMonitor = undefined;
            return lib["Promise"].reject(error);
        });
    };
    AtMentionControl.prototype._getPeoplePickerQueryParams = function () {
        return {
    ...
    AtMentionControl.prototype._onRenderSuggestionItem = function (person) {
    ...
    AtMentionControl.prototype._updatePlaceHolder = function () {
        var editorElement = this.props.editorElement;
        var placeholderAttr = 'placeholder';
        var placeHolderText = editorElement.getAttribute(placeholderAttr);
        if (placeHolderText) {
            this.props.editorElement.setAttribute(placeholderAttr, sp_core_library_["Text"].format(AtMention_resx["a" /* default */].mentionPlaceholderText, placeHolderText));
        }
    };
    AtMentionControl.prototype._loadAndShowCoachmark = function () {
        var coachmark = external__react_["createElement"](AtMention_DeferredCoachmarkHost, {
            deferredProps: {
                target: this.props.editorElement,
                onDismiss: this._dismissCoachmark
            }
        });
        this._coachmarkElement = document.createElement('div');
        external__react_dom_["render"](coachmark, this._coachmarkElement);
    };
    AtMentionControl.prototype._dismissCoachmark = function (ev) {
        if (this._coachmarkElement) {
            external__react_dom_["unmountComponentAtNode"](this._coachmarkElement);
            if (!ev || ev.type !== 'scroll') {
                window.localStorage.setItem(MENTION_COACHMARK_DISMISSED_KEY, '1');
            }
            this._coachmarkElement = undefined;
        }
    };
    AtMentionControl.BRACKET_REGEX = /\s\(([^)]*)\)[^(]*$/g;
    AtMentionControl.LAST_NAME_SECTION_REGEX = /\s[^\s]*$/g;
    AtMentionControl.RELEVANT_USER_QUERY = '@@';
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_handleMention", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_dissmissTooltip", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_handleFilterChanged", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_onPersonaSelected", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_getTextFromItem", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_handleKeydown", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_handleResolveSuggestions", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_onGetMoreResults", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_onRenderSuggestionItem", null);
    tslib_es6["__decorate"]([
        office_ui_fabric_react_bundle_["autobind"]
    ], AtMentionControl.prototype, "_dismissCoachmark", null);
    return AtMentionControl;
}(office_ui_fabric_react_bundle_["BaseComponent"]));
/* harmony default export */ var AtMention_AtMentionControl = __webpack_exports__["default"] = (AtMentionControl_AtMentionControl);


/***/ })
]));
//# sourceMappingURL=0.0_a044d616d5519e63d38c.js.map