webpackJsonp8be81a5c_af38_4bb2_af97_afa3b64dfbed_1_7_0([4],{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__microsoft_sp_diagnostics__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__microsoft_sp_lodash_subset__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ms_odsp_utilities_bundle__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__CanvasStoreCommonActions__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__canvasLayout_CanvasLayout__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__common_KillSwitches__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__loc_CanvasStrings_resx__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__CanvasWebPartClassification__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__a11y_CanvasA11yConstants__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__common_Flights__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__canvasLayout_undefinedControlPosition__ = __webpack_require__(24);
...
var CanvasStoreEditActions = (function () {
    ...
    CanvasStoreEditActions.closeToolbox = function (canvasFields, ev) {
        ...
        canvasFields.toolboxProps.controlPosition = __WEBPACK_IMPORTED_MODULE_15__canvasLayout_undefinedControlPosition__["a" /* undefinedControlPosition */];
        canvasFields.render();
    };
    CanvasStoreEditActions.handleConfigureButtonClicked = function (canvasFields, id) {
        ...
        if (controlComponent) {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_10__common_KillSwitches__["a" /* default */].isZoneIndexResetKillSwitchActivated()) {
    ...
    CanvasStoreEditActions.handleDuplicateControlButtonClicked = function (canvasFields, id) {
        ...
        var newLayoutIndex = __WEBPACK_IMPORTED_MODULE_9__canvasLayout_CanvasLayout__["a" /* default */].generateNewLayoutIndex(canvasFields.canvasLayout
        ...
        duplicateControlData.position = __WEBPACK_IMPORTED_MODULE_0_tslib__["__assign"]({}, duplicateControlData.position, { controlIndex: newLayoutIndex });
        __WEBPACK_IMPORTED_MODULE_8__CanvasStoreCommonActions__["a" /* default */].addControlToCanvas(canvasFields, duplicateControlData, true);
    };
    CanvasStoreEditActions.handleDuplicateZoneButtonClicked = function (canvasFields, id) {
        ...
        var newLayoutIndex = __WEBPACK_IMPORTED_MODULE_9__canvasLayout_CanvasLayout__["a" /* default */].generateNewLayoutIndex(canvasFields.canvasLayout.zones, originalZone.index, true);
        originalZone.fetchAllControls(true).forEach(function (control) {
            ...
            duplicateControlData.position = __WEBPACK_IMPORTED_MODULE_0_tslib__["__assign"]({}, duplicateControlData.position, { zoneIndex: newLayoutIndex });
            __WEBPACK_IMPORTED_MODULE_8__CanvasStoreCommonActions__["a" /* default */].addControlToCanvas(canvasFields, duplicateControlData, false);
        });
        canvasFields.render();
    };
    ...
    CanvasStoreEditActions.handleDeleteControlDialogDismiss = function (canvasFields) {
        canvasFields.positionCandidateForDeletion = __WEBPACK_IMPORTED_MODULE_15__canvasLayout_undefinedControlPosition__["a" /* undefinedControlPosition */];
    ...
    CanvasStoreEditActions._cloneControl = function (control) {
        ...
        var newId = __WEBPACK_IMPORTED_MODULE_2__microsoft_sp_core_library__["Guid"].newGuid().toString();
        duplicateControlData.id = newId;
        if (duplicateControlData.controlType === __WEBPACK_IMPORTED_MODULE_7__canvasControl_CanvasControlType__["a" /* default */].WebPartZone) {
...
//# sourceMappingURL=4.4_4c6ac99cf0a3a4aaf266.js.map