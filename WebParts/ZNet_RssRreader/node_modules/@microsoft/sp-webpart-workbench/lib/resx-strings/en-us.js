define([], function() {
  var strings = {
    ...
    "_O6tJrUs6NrlW91qKLBlc7g": {
      "loadingText": "Loading…",
      "relevantPeopleHeaderText": "People you work with",
      "noResultsFoundText": "We didn't find any matches",
      ...
      "noPermissionText": "{0} does not have permission to this page, so will not be notified about your comment.",
      "mentionLink": "@{0}",
      "teachingBubbleHeadline": "@Mention",
      "teachingBubbleContent": "You can @mention people in comments when you want to get their attention. Just type the @ symbol before a name to get started!",
      "mentionPlaceholderText": "{0}. Type @ to mention someone",
      "CloseButtonAriaLabel": "Close",
      "searchDirectory": "Search directory",
      "mentionAlertMessage": "Mention added for {0}"
    },
