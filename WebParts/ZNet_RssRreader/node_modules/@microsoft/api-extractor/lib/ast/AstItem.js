...
class AstItem {
    constructor(options) {
        ...
        let inputTextRange = tsdoc.TextRange.empty;
        if (options.aedocCommentRange) {
            ...
            inputTextRange = tsdoc.TextRange.fromStringRange(sourceFileText, options.aedocCommentRange.pos, options.aedocCommentRange.end);
        }
        else {
            ...
            if (ranges.length > 0) {
                ...
                inputTextRange = tsdoc.TextRange.fromStringRange(sourceFileText, lastRange.pos, lastRange.end);
            }
        }
        this.documentation = new ApiDocumentation_1.ApiDocumentation(inputTextRange, this.context.docItemLoader, this.context, this.reportError, this.warnings);
    }
    /**
     ...
     */
    reportError(message, startIndex) {
        if (!startIndex) {
