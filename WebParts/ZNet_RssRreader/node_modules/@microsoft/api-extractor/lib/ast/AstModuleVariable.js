 ...
 */
class AstModuleVariable extends AstMember_1.AstMember {
    constructor(options) {
        super(options);
        this.kind = AstItem_1.AstItemKind.ModuleVariable;
        const propertySignature = options.declaration;
...
exports.AstModuleVariable = AstModuleVariable;
