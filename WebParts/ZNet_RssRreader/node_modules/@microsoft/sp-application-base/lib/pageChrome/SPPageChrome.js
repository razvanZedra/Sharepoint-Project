...
var SPPageChrome = (function () {
    ...
    SPPageChrome.prototype._createPageChrome = function () {
        ...
        if (!_SPKillSwitch.isActivated(SPPageChrome.MOVE_NAVIGATE_BY_HIERARCHY, '09/11/2018', 'MoveNavigateByHierarchy')) {
    ...
    SPPageChrome.MOVE_NAVIGATE_BY_HIERARCHY = Guid.parse('0d111e46-bb27-4bad-8362-831ff5284165');
    return SPPageChrome;
}());
