...
export default class Navigator {
    ...
    private _validatePreloadedData(preloadedData);
    private _isDataPrefetchSupported(componentId);
    private _processDataPrefetch(url, preloadedData, prefetchData, shouldRaiseEvent);
}
