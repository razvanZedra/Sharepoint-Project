webpackJsonp4df9bb86_ab0a_4aab_ab5f_48bf167048fb_1_7_0([0],{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__microsoft_sp_lodash_subset__ = __webpack_require__(36);
...
var NavigationDataStore = (function () {
    ...
    NavigationDataStore._generatePrefetchHeaders = function () {
    ...
    NavigationDataStore.prototype._fetchData = function (url, props, cachedItem, cachedItemIdx) {
        var _this = this;
        var preloadedDataPromise = this._executor(url).then(function (navData) {
        ...
        if (props && props.enableDataPrefetch) {
            ...
            prefetchedDataPromise =
                this._executor(url, NavigationDataStore._generatePrefetchHeaders()).then(function (appData) {
...
//# sourceMappingURL=0.0_098c06c2cb81cc3dfb10.js.map