...
import { _SPTelemetryLogHandler, _Telemetry, _PerformanceLogger } from '@ms/sp-telemetry';
import { _Diagnostics, _QosMonitor } from '@microsoft/sp-diagnostics';
...
import { setIsSpHome } from './utilities/react16RolloutHelper';
import { spHomeComponentId } from './utilities/componentConstants';
...
var SPStarter = (function () {
    ...
    SPStarter.start = function (preloadedData, handleFailure, debugData) {
        ...
        if (!_SPKillSwitch.isActivated(Guid.parse('73c82d72-e671-400d-a6bb-6215bd84b649'), '2018/10/11', 'SPHome does not flight React16')) {
            setIsSpHome(preloadedData.clientSideApplicationId === spHomeComponentId);
        }
    ...
    SPStarter._isTelemetryDisabled = function () {
        ...
        if (!_SPKillSwitch.isActivated(SPStarter.ariaTelemetryKillSwitch, '2018/08/17', 'Disabeling aria telemetry')) {
    ...
    SPStarter.ariaTelemetryKillSwitch = Guid.parse('177EA1AE-7501-4DB9-9EFB-9A179BC70E52');
    return SPStarter;
}());
