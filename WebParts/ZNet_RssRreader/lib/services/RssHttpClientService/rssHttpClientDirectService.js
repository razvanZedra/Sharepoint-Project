...
var RssHttpClientDirectService = (function () {
    function RssHttpClientDirectService() {
    }
    RssHttpClientDirectService.prototype.get = function (feedRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var p;
            return __generator(this, function (_a) {
                p = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var rawFeedOutput, response, err_1, feedOutput, err_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                rawFeedOutput = null;
                            ...
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, RssHttpClientService.getRssXml(feedRequest.url, feedRequest.useCorsProxy ? feedRequest.corsProxyUrl : "", feedRequest.disableCorsMode)];
                            case 2:
                            ...
                            case 3:
                                ...
                                return [2 /*return*/];
                            case 4:
                                if (!rawFeedOutput) return [3 /*break*/, 8];
                                RssXmlParserService.init();
                                _a.label = 5;
                            case 5:
                                _a.trys.push([5, 7, , 8]);
                                return [4 /*yield*/, RssXmlParserService.parse(rawFeedOutput)];
                            case 6:
                                feedOutput = _a.sent();
                                if (feedOutput) {
    ...
    RssHttpClientDirectService.prototype.convertRssFeedToRssReaderResponse = function (input, maxCount) {
    ...
    return RssHttpClientDirectService;
}());
export { RssHttpClientDirectService };
//# sourceMappingURL=rssHttpClientDirectService.js.map