...
var RssHttpClientRss2JsonService = (function () {
    function RssHttpClientRss2JsonService() {
    }
    RssHttpClientRss2JsonService.prototype.get = function (feedRequest) {
                ...
                p = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                                rssUrl = "https://api.rss2json.com/v1/api.json?rss_url=" + encodeURIComponent(feedRequest.url)
                                    + (feedRequest.feedServiceApiKey ? "&api_key=" + encodeURIComponent(feedRequest.feedServiceApiKey) : "")
                                    + ((feedRequest.maxCount && feedRequest.feedServiceApiKey) ? "&count=" + feedRequest.maxCount : "");
    ...
    RssHttpClientRss2JsonService.prototype.convertRssFeedToRssReaderResponse = function (input, maxCount) {
    ...
    return RssHttpClientRss2JsonService;
}());
export { RssHttpClientRss2JsonService };
//# sourceMappingURL=rssHttpClientRss2JsonService.js.map