...
var TextDialog = (function (_super) {
    ...
    TextDialog.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Button, { label: this.props.strings.dialogButtonLabel, onClick: this.showDialog.bind(this), disabled: this.props.disabled }, this.props.strings.dialogButtonText),
            React.createElement(Dialog, { type: DialogType.normal, isOpen: this.state.showDialog, onDismiss: this.cancelDialog.bind(this), title: this.props.strings.dialogTitle, subText: this.props.strings.dialogSubText, isBlocking: true, modalProps: {
                    containerClassName: 'ms-dialogMainOverride ' + styles.textDialog,
                } },
                React.createElement(AceEditor, { width: "600px", mode: "html", theme: "monokai", enableLiveAutocompletion: true, showPrintMargin: false, showGutter: true, onChange: this.onDialogTextChanged.bind(this), value: this.state.dialogText, name: "CodeEditor" }),
